...
# Updated body for Dr. Pankaj Kumar (Alumni & Power Sector focus)
HTML_BODY = """
<body>
    <div class="content">
        <p>Dear Dr. Kumar,</p>
        ...
        <p>My name is <strong>{your_name}</strong>, representing <span class="highlight">TeamKART</span>. As a fellow KGPian, I am reaching out to you at Tata Power DDL to share our progress and explore a potential CSR collaboration focused on sustainable energy and technical research—areas where Tata Power continues to lead India's transition to a greener future.</p>
...
HTML_TAIL = """
        ...
        <div class="footer">
            <p>Thank you for your time and consideration. We would be glad to connect with an alumnus of your stature.</p>
            <p>Warm regards,</p>
